             ...
             */
                ...
                var Expander = kity.createClass("Expander", {
                    ...
                    constructor: function(node) {
                        this.callBase();
                        this.radius = 6;
                        this.outline = new kity.Circle(this.radius).stroke("#4c9ff2").fill("white");
                        this.sign = new kity.Path().stroke("#4c9ff2");
        ...
        value: function(require, exports, module) {
            ...
            function generate(h, compat) {
                return {
                    ...
                    "root-stroke-width": '1',
                    "root-font-size": 17,
                    "root-padding": compat ? [ 6, 12 ] : [ 15, 34 ],
                    "root-margin": compat ? 10 : [ 30, 100 ],
                    "root-radius": 6,
                    "root-space": 10,
                    "main-color": "#1b1b1b",
                    "main-background": '#e1f5ff',
                    "main-stroke": '#9ccdff',
                    "main-stroke-width": 1,
                    "main-font-size": 15,
                    "main-padding": [ 8, 20 ],
