...
_p[23] = {
    value: function(require, exports, module) {
        ...
        kity.extendClass(Minder, {
            ...
            renderTo: function(target) { // 传递的dom结构
                if (typeof target == "string") {
                    target = document.querySelector(target);
                }
                if (target) {
            ...
            getRenderTarget: function() { // 获取容器的dom
        ...
        var ViewDragger = kity.createClass("ViewDragger", {
            ...
            _bind: function() {
                ...
                this._minder.on("normal.mousedown normal.touchstart " + "inputready.mousedown inputready.touchstart " + "readonly.mousedown readonly.touchstart", function(e) {
                    ...
                    // 点击未选中的根节点临时开启 e.getTargetNode() == this.getRoot() ||
                    if ( e.originEvent.button == 2 || e.originEvent.altKey) {
         ...
         */
            var CameraCommand = kity.createClass("CameraCommand", {
                ...
                execute: function(km, focusNode) {
                    ...
                    var dx = viewport.center.x / 2, dy = viewport.center.y - offset.y;
                ...
                events: {
                    ...
                    resize: function(e) {
                        var a = {
                            width: this.getRenderTarget().clientWidth,
                            height: this.getRenderTarget().clientHeight
                        }, b = this._lastClientSize; // 获取外部容器dom的宽高
